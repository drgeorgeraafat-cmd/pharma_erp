frappe.ui.form.on("Pharmacy Return Case", {
    refresh(frm) {
        ...
        if (frm.doc.rejection_return_stock_entry) {
            frm.add_custom_button(__("Rejected Quantity Return"), () => {
        ...
        if (frm.doc.supplier_claim) {
            frm.add_custom_button(__("Supplier Claim"), () => {
